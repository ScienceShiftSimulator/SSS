...
function task_A_SetFlow(){
  ...
  this.mouseclick = function(evt){
    ...
    var u = this.points_u ;
    var d = this.points_d ;
    var a = 1/(2*this.triangle_area) ;
    var su = a*(u[0][1]*u[2][0] - u[0][0]*u[2][1] + (u[2][1] - u[0][1])*XY[0] + (u[0][0] - u[2][0])*XY[1]) ;
    var tu = a*(u[0][0]*u[1][1] - u[0][1]*u[1][0] + (u[0][1] - u[1][1])*XY[0] + (u[1][0] - u[0][0])*XY[1]) ;
    var sd = a*(d[0][1]*d[2][0] - d[0][0]*u[2][1] + (d[2][1] - d[0][1])*XY[0] + (d[0][0] - d[2][0])*XY[1]) ;
    var td = a*(d[0][0]*d[1][1] - d[0][1]*u[1][0] + (d[0][1] - d[1][1])*XY[0] + (d[1][0] - d[0][0])*XY[1]) ;
